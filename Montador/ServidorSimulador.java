...
public class ServidorSimulador {
    ...
    private static final String ARQUIVO_FONTE_PRINCIPAL = "main.asm";
    private static final String ARQUIVO_HTML_SIMULADOR = "maquina.html"; // Mude se o nome for outro
    private static final String ARQUIVO_SAIDA_TXT = "programa.txt";
    ...
    static class CompileHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            try {
                ...
                String arquivoExpandido = "MASMAPRG.ASM";
                ...
                ligador.ligarArquivos(new String[]{arquivoObj}, "programa.HPX", true);

                // 4. Carregador
                List<String> linhasHpx = Files.readAllLines(Paths.get("programa.HPX"));
